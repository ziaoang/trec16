...
from package.relation import jm2_score, sym_jm2_score

######################################################### Config
client_id              = 'TyeaK74Lafp2'
...
def sim_q_t(query, tweet):
    return jm2_score(query, tweet, corpus_dict)
    
def sim_t_t(tweet_1, tweet_2):
    return sym_jm2_score(tweet_1, tweet_2, corpus_dict)
